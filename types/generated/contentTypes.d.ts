...
export interface ApiAgencyAgency extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.String;
    agencyLicense: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::agency.agency'>;
  };
}
...
export interface ApiAgentAgent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    agentLicenseNumber: Schema.Attribute.String;
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    location: Schema.Attribute.Component<'shared.location', false>;
    catastroId: Schema.Attribute.String;
